...
enum class NodeAdvancedStatus : int8_t
{
  IDLE = 0,
  RUNNING = 1,
  SUCCESS = 2,
...
inline const NodeStatus (&EnumValuesNodeStatus())[5]
{
...
{
  static const char* const names[6] = {"IDLE", "RUNNING", "SUCCESS", "FAILURE", "SKIPPED", nullptr};
  return names;
}

inline const char* EnumNameNodeStatus(NodeStatus e)
{
  if (flatbuffers::IsOutRange(e, NodeStatus::IDLE, NodeStatus::SKIPPED))
    return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesNodeStatus()[index];
}

inline const NodeAdvancedStatus (&EnumValuesNodeAdvancedStatus())[6]
{
  static const NodeAdvancedStatus values[] = {NodeAdvancedStatus::IDLE, NodeAdvancedStatus::RUNNING,
                                      NodeAdvancedStatus::SUCCESS, NodeAdvancedStatus::FAILURE,
                                      NodeAdvancedStatus::SKIPPED, NodeAdvancedStatus::PAUSED};
  return values;
}

inline const char* const* EnumNamesNodeAdvancedStatus()
{
  static const char* const names[7] = {"IDLE", "RUNNING", "SUCCESS", "FAILURE", "SKIPPED", "PAUSED", nullptr};
  return names;
}

inline const char* EnumNameNodeAdvancedStatus(NodeAdvancedStatus e)
{
  if (flatbuffers::IsOutRange(e, NodeAdvancedStatus::IDLE, NodeAdvancedStatus::PAUSED))
    return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesNodeAdvancedStatus()[index];
}
...
public:
  ...
  StatusChange(uint16_t _uid, Serialization::NodeAdvancedStatus _prev_status,
               Serialization::NodeAdvancedStatus _status,
  ...
  Serialization::NodeAdvancedStatus prev_status() const
  {
    return static_cast<Serialization::NodeAdvancedStatus>(
        flatbuffers::EndianScalar(prev_status_));
  }
  Serialization::NodeAdvancedStatus status() const
  {
    return static_cast<Serialization::NodeAdvancedStatus>(flatbuffers::EndianScalar(status_));
  }
...
struct TreeNode FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
  ...
  uint8_t bp() const
  {
    return GetField<uint8_t>(VT_BP, 0);
  }
  uint8_t disabled() const
  {
    return GetField<uint8_t>(VT_DISABLED, 0);
  }
  ...
  Serialization::NodeAdvancedStatus status() const
  {
    return static_cast<Serialization::NodeAdvancedStatus>(GetField<int8_t>(VT_STATUS, 0));
  }
  ...
  bool Verify(flatbuffers::Verifier& verifier) const
  {
    return VerifyTableStart(verifier) && VerifyField<uint16_t>(verifier, VT_UID) &&
           VerifyField<uint8_t>(verifier, VT_BP) &&
...
struct TreeNodeBuilder
{
  ...
  void add_disabled(uint8_t disabled)
  {
    fbb_.AddElement<uint8_t>(TreeNode::VT_DISABLED, disabled, 0);
  }
  void add_bp(uint8_t bp)
  {
    fbb_.AddElement<uint8_t>(TreeNode::VT_BP, bp, 0);
  }
  ...
  void add_status(Serialization::NodeAdvancedStatus status)
  {
    ...
    uint8_t bp = 0)
{
  ...
  return Serialization::CreateTreeNode(_fbb, uid, children_uid__, status, instance_name__,
                                       registration_name__, port_remaps__, disabled, bp);
}
